                        ...
                        @foreach ($photo as $item)
                            <div class="hidden duration-1000 ease-in-out" data-carousel-item>
                                <div class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
                                    <img src="{{ asset('gallery/image/' . $item->image) }}" class="" alt="Image 1">
                                    <p id="details-text" class="text-sm mt-4"> {{$item->titile}}</p>
                                    <p id="details-text" class="text-sm mt-2"> {{$item->description}}</p>
                                    <div class="flex justify-between mt-3">
                                        <p class="text-base text-green-700 font-semibold">By {{$item->organised_by}}</p>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            btn.addEventListener('click', function() {
                ...
                const selectedItem = document.querySelector(`[data-carousel-item] img[src*="${itemId}"]`).closest('[data-carousel-item]');
