    ...
    <div class="max-w-6xl mx-auto py-12">
        ...
        <div id="donating-event"
            ...
            <div class="bg-white rounded-lg overflow-hidden shadow-xl transform transition-all max-w-lg w-full p-4">
                ...
                <h2 id="modalTitle" class="text-lg text-green-500 mb-4 font-semibold"></h2>
                <form id="addDonationData">
                    ...
                    <form id="donation-form">
                        ...
                        <div class="mb-4">
                            ...
                            <input
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                name="amount" id="amount" type="number" placeholder="Enter Amount">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                name="message" id="message" placeholder="Enter any message"></textarea>
        ...
        <section class="container mx-auto my-12 px-12 mt-20">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="flex items-center">
                    <img src="{{ asset('images/pimg2.jpg') }}" alt="Women Empowerment"
        ...
        <section class="bg-white py-12">
            ...
            <div class="bg-[#2980b9] mt-10">
                <div class="max-w-5xl mx-auto text-white px-16 py-10 rounded-lg relative">
                    ...
                    <button id="nextBtn"
                        class="absolute right-0 top-1/2 transform -translate-y-1/2  text-blue-900 p-2 ">
                    ...
                    let callingData = () => {
                        ...
                        `);
                                ...
                                $('.donate-btn').on('click', function(event) {
                                    ...
                                    $('#modalTitle').text(`Donate to: ${category}`);
                                    $('#category').text(`Donate to: ${category}`);
                                    $('#donating_for').val(`Donate to: ${category}`);
